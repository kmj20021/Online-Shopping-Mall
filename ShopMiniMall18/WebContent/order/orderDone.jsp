...
<%
  	OrderDTO oDTO =(OrderDTO) request.getAttribute("orderDTO");
	int total = oDTO.getgPrice() * oDTO.getgAmount();
%>
<table width="70%" cellspacing="0" cellpadding="0">
	...
	<tr>
		<td class="td_default" align="center"><b><%= oDTO.getUserid()%></b> 님의 주문이
			안전하게 처리되었습니다.</td>
	</tr>
		...
		<td>
			<table width="100%" border="1" style="border-collapse: collapse"
				...
				<tr>
					...
					<td class="td_default" height="35"> (<%= oDTO.getPost() %>) <%= oDTO.getAddr1() %> <%= oDTO.getAddr2() %><br>
